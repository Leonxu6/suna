...
3. Trace execution-lease, workspace-access, model, and session request graphs.
...
2. Remove speculative resume from `loadWorkspaceForUser()`.
...
4. Start model-picker and workspace-detail requests in parallel.
