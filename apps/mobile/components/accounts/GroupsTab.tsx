 ...
 * groups; tap a group to open its detail (members + workspace access).
 */
  ...
  return (
    <View style={{ flex: 1 }}>
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={query.isRefetching} onRefresh={() => query.refetch()} tintColor={c.muted} />}
      >
