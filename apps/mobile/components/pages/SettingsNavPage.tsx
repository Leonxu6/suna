...
import type { KortixWorkspace, ExperimentalFeatureView } from '@/lib/workspaces/workspaces-client';
...
function ExperimentalRow({ workspaceId, feature, canManage, isDark }: { workspaceId: string; feature: ExperimentalFeatureView; canManage: boolean; isDark: boolean }) {
  const c = useColors(isDark);
  const { colorScheme } = useColorScheme();
  const update = useUpdateExperimentalFeature(workspaceId);
