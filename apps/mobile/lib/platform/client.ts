...
// `stopWorkspaceSession` was never re-exported by mobile's workspaces-client.ts
// (mobile didn't have a "pause in place" caller before this file); pull it
// straight from the SDK's public `workspaces-client` subpath instead of adding
// an export mobile itself doesn't otherwise need.
import { stopWorkspaceSession } from '@kortix/sdk/workspaces-client';
...
export type SandboxServiceScope = 'bootstrap' | 'core' | 'workspace' | 'session';
