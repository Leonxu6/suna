import type {
  ClaimWarmWorkspaceSessionInput,
  WorkspaceSession,
} from '@kortix/sdk';
...
export async function resolveWarmSessionForSend(
  current: Pick<WorkspaceSession, 'session_id'> | undefined,
  resolve?: () => Promise<Pick<WorkspaceSession, 'session_id'> | undefined>,
): Promise<Pick<WorkspaceSession, 'session_id'> | undefined> {
...
export function buildWarmSessionClaimInput(
  session: Pick<WorkspaceSession, 'session_id'>,
