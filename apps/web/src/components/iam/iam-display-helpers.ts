...
// group-detail page, workspace Members page so the precedence + sort logic
...
//      the group's workspace grant (super-admin > owner > admin > member).
 ...
 * every workspace regardless of the group's role.
 */
...
/**
 * Number of members whose access overrides the group's workspace grants.
 ...
 * implicit Manager, no direct workspace_members row).
 */
