...
// v1 — no deny effect, no conditions, no token principals, no workspace_group
                  ...
                  : principalType === 'group'
                    ...
                    : principalType === 'service_account'
                      ...
                      : (() => {
                          ...
                          if (!workspaceId)
                            return <SelectItem value="__none" disabled>Select a workspace first</SelectItem>;
                          const workspaceAgents = agents.filter((a) => a.workspace_id === workspaceId);
                          if (workspaceAgents.length === 0)
                            return <SelectItem value="__none" disabled>No agents in this workspace</SelectItem>;
