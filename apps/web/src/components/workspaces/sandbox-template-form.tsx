...
/**
 * Create / edit dialog for a workspace's sandbox template.
 *
 ...
 * path in the workspace repo OR a public `image` reference. The Kortix runtime
...
export function SandboxTemplateForm({
  ...
  const createMut = useMutation({
    mutationFn: () =>
      createSandboxTemplate(workspaceId, {
        slug,
        name: name.trim(),
        ...(mode === 'image'
          ? { image: image.trim() }
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['workspace-snapshots', workspaceId] });
  ...
  const editMut = useMutation({
    mutationFn: () =>
      updateSandboxTemplate(workspaceId, template!.template_id!, {
        name: name.trim(),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {tI18nHardcoded.raw(
              'autoComponentsWorkspacesSandboxTemplateFormJsxTextDefineASandbox3c0ec6b6',
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
            ...
            <div>
              ...
              <Input
                ...
                placeholder={tI18nHardcoded.raw(
                  'autoComponentsWorkspacesSandboxTemplateFormJsxAttrPlaceholderMLDevelopment53e1277c',
                )}
                value={name}
          ...
          <div>
            <Label>
              {tI18nHardcoded.raw(
                'autoComponentsWorkspacesSandboxTemplateFormJsxTextImageSourcecaa2d535',
              )}
            </Label>
            <div className="mt-2 grid grid-cols-2 gap-2">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">
                    {tI18nHardcoded.raw(
                      'autoComponentsWorkspacesSandboxTemplateFormJsxTextPublicImage51d40ec2',
                    )}
                  </span>
                </div>
              ...
              >
                ...
                <span className="text-muted-foreground text-xs">
                  {tI18nHardcoded.raw(
                    'autoComponentsWorkspacesSandboxTemplateFormJsxTextPathInsideThis6fc72ad4',
                  )}
                </span>
              </button>
            </div>
              ...
              {mode === 'image' ? (
                <>
                  ...
                  <p className="text-muted-foreground mt-1 text-xs">
                    {tI18nHardcoded.raw(
                      'autoComponentsWorkspacesSandboxTemplateFormJsxTextMustIncludeA5f4b959e',
                    )}
                ...
                <>
                  <Label htmlFor="tpl-df">
                    {tI18nHardcoded.raw(
                      'autoComponentsWorkspacesSandboxTemplateFormJsxTextDockerfilePathda3717f2',
                    )}
                  </Label>
                  <Input
                    id="tpl-df"
                  ...
                  <p className="text-muted-foreground mt-1 text-xs">
                    {tI18nHardcoded.raw(
                      'autoComponentsWorkspacesSandboxTemplateFormJsxTextRelativeToThe552e0897',
                    )}
                  </p>
                </>
              )}
            ...
            <div className="mt-2 grid grid-cols-3 gap-3">
              ...
              <NumericField
                ...
                label={tI18nHardcoded.raw(
                  'autoComponentsWorkspacesSandboxTemplateFormJsxAttrLabelMemoryGiB200ca9a8',
                )}
                value={memoryGb}
              ...
              <NumericField
                id="disk"
                label={tI18nHardcoded.raw(
                  'autoComponentsWorkspacesSandboxTemplateFormJsxAttrLabelDiskGiB94935856',
                )}
                value={diskGb}
                onChange={setDiskGb}
                min={1}
          ...
          <div>
            ...
            <Textarea
              id="tpl-entry"
              placeholder={tI18nHardcoded.raw(
                'autoComponentsWorkspacesSandboxTemplateFormJsxAttrPlaceholderLeaveBlank4adf74ef',
              )}
              value={entrypoint}
