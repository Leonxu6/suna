...
export function PersonalOnboardingWelcome({ workspaceId }: { workspaceId?: string } = {}) {
  ...
  const wizardPending = !!workspaceId && onboarding.hydrated && onboarding.status === 'pending';
    ...
    <>
      <Card
        ...
        aria-label={tI18nHardcoded.raw(
          'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxAttrAriaLabelWelcome436613af',
        )}
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <CardTitle className="text-balance">
                {tI18nHardcoded.raw(
                  'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxTextHeyIMe9d73cdb',
                )}
              </CardTitle>
              <CardDescription>
                {tI18nHardcoded.raw(
                  'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxTextFounderCEOKortix4be58c34',
                )}
              </CardDescription>
            </div>
          </div>
        ...
        <CardContent className="px-4">
          <p className="text-foreground/90 text-sm leading-relaxed text-pretty">
            {tI18nHardcoded.raw(
              'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxTextWantAHandf0a0c56c',
            )}
        ...
        <CardFooter className="flex-wrap gap-2 px-4">
          <Button size="sm" onClick={() => setQualifierOpen(true)}>
            <TelephoneSolid />
            {tI18nHardcoded.raw(
              'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxTextBookADemo7f3fc2d5',
            )}
          </Button>
      ...
      <DemoQualifierModal
        ...
        title={tI18nHardcoded.raw(
          'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxAttrTitleBookA33a960c8',
        )}
        description={tI18nHardcoded.raw(
          'autoComponentsWorkspacesPersonalOnboardingWelcomeJsxAttrDescriptionACouple5d67eddc',
        )}
