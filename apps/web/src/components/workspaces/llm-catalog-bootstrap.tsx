 ...
 * (`GET /workspaces/:id/llm-catalog/providers`) once per workspace, as early as
 * possible (mounted at the workspace layout, alongside SessionCacheWarmer).
 *
 ...
 * opens "Customize > LLM Provider" in a given workspace never gets live data
 ...
 */
export function LlmCatalogBootstrap({ workspaceId }: { workspaceId: string }) {
  useLiveLlmProviderCatalog(workspaceId, true);
  return null;
}
