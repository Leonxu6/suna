...
export function SessionDeleteModal({
  ...
  return (
    <ConfirmDialog
      ...
      title={tHardcodedUi.raw('componentsWorkspacesWorkspaceSessionList.line189JsxTextDeleteSession')}
      description={
        <>
          {tHardcodedUi.raw(
            'componentsWorkspacesWorkspaceSessionList.line191JsxTextThisWillPermanentlyDestroyTheBranchAndSandbox',
          )}{' '}
          <span className="text-foreground font-medium">{sessionLabel}</span>
          {tHardcodedUi.raw(
            'componentsWorkspacesWorkspaceSessionList.line193JsxTextThisActionCannotBeUndone',
          )}
        </>
      }
      confirmLabel="Delete"
