...
export function RenameSessionModal({
  ...
  const renameMutation = useMutation({
    mutationFn: (name: string) => {
      ...
      return updateWorkspaceSession(workspaceId, sessionId, { name });
    },
    ...
    >
      <ModalContent className="lg:max-w-md">
        <ModalHeader>
          <ModalTitle>
            {tI18nHardcoded.raw(
              'autoFeaturesCoWorkerWorkspaceSidebarModalRenameSessionModalJsx265e123d',
            )}
          </ModalTitle>
          <ModalDescription>
            {tI18nHardcoded.raw(
              'autoFeaturesCoWorkerWorkspaceSidebarModalRenameSessionModalJsx19d80686',
            )}
          </ModalDescription>
        </ModalHeader>
        <ModalBody>
          <Input
            ...
            placeholder={tI18nHardcoded.raw(
              'autoFeaturesCoWorkerWorkspaceSidebarModalRenameSessionModalJsx2412472b',
            )}
