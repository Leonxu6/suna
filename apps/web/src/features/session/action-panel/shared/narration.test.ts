...
describe('narrateStep - workspaces/skills are count-aware, not just parts[0]', () => {
  it('reports the count for multiple created workspaces instead of only naming the first', () => {
