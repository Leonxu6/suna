/**
 * Workspace Files feature — read-only, git-backed.
 *
 * Mirrors the sandbox `features/files` module's public surface but every
 * data hook reads from `/v1/workspaces/:workspaceId/files` via React context.
 */
...
// Per-workspace Version selection
