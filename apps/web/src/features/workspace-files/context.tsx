 ...
 * current workspace's id and git ref. The route-level shell sets this once
 * (see `apps/web/src/app/workspaces/[id]/files/page.tsx`).
 *
...
/**
 * Read the active workspace context. Returns `null` outside a provider —
 ...
 *  cannot meaningfully render without workspace context. */
