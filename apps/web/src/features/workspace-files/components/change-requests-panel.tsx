 ...
 * the active workspace, filterable by status. Clicking a row opens the detail
      ...
      >
        <div className="border-border flex h-12 shrink-0 items-center gap-2 border-b px-3">
          <span className="text-sm font-medium">
            {tHardcodedUi.raw(
              'featuresWorkspaceFilesComponentsChangeRequestsPanel.line131JsxTextChangeRequests',
            )}
          </span>
          {activeRef && (
            <span
          ...
          <Button
            ...
            title={tHardcodedUi.raw(
              'featuresWorkspaceFilesComponentsChangeRequestsPanel.line145JsxAttrTitleOpenANewChangeRequest',
            )}
          >
            ...
            {!isLoading && !error && total === 0 && (
              <div className="flex flex-col items-center justify-center gap-2 p-6 text-center">
                ...
                <p className="text-muted-foreground text-xs">
                  {tHardcodedUi.raw(
                    'featuresWorkspaceFilesComponentsChangeRequestsPanel.line199JsxTextChangeRequests',
                  )}
                </p>
                {status === 'open' && (
                  <Button
                  ...
                  >
                    <Plus className="h-3.5 w-3.5" />
                    {tHardcodedUi.raw(
                      'featuresWorkspaceFilesComponentsChangeRequestsPanel.line209JsxTextOpenTheFirstOne',
                    )}
                  </Button>
                )}
              </div>
