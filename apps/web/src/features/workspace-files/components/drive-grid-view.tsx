...
function FolderCard({
  ...
  const openFolderLabel = tHardcodedUi.raw(
    'featuresWorkspaceFilesComponentsDriveGridView.line209JsxTextOpenFolder',
  );
  const copyPathLabel = tHardcodedUi.raw(
    'featuresWorkspaceFilesComponentsDriveGridView.line231JsxTextCopyPath',
  );
...
function FileCard({
  ...
  const copyPathLabel = tHardcodedUi.raw(
    'featuresWorkspaceFilesComponentsDriveGridView.line420JsxTextCopyPath',
  );
  const checkpointHistoryLabel = tHardcodedUi.raw(
    'featuresWorkspaceFilesComponentsDriveGridView.line402JsxTextCheckpointHistory',
  );
  const fileMenuProps = {
    node,
    onClick,
...
const ELEVATED_DIR_META: Record<string, { description: string }> = {
  '.kortix': { description: 'Workspace config, tasks, context' },
