          ...
          <ScrollArea className="h-full">
            ...
            {error && !isLoading && (
              <div className="flex flex-col items-center justify-center gap-2 p-6 text-center">
                ...
                <p className="text-muted-foreground text-xs">
                  {tHardcodedUi.raw(
                    'featuresWorkspaceFilesComponentsCheckpointsPanel.line230JsxTextFailedToLoadCheckpoints',
                  )}
                </p>
            ...
            {!isLoading && !error && total === 0 && (
              <div className="flex flex-col items-center justify-center gap-2 p-6 text-center">
                ...
                <p className="text-muted-foreground text-xs">
                  {tHardcodedUi.raw(
                    'featuresWorkspaceFilesComponentsCheckpointsPanel.line241JsxTextNoCheckpointsYet',
                  )}
                </p>
              </div>
            )}
                ...
                {data?.hasMore && (
                  <div className="py-2 text-center">
                    <span className="text-muted-foreground/50 text-xs">
                      {tHardcodedUi.raw(
                        'featuresWorkspaceFilesComponentsCheckpointsPanel.line278JsxTextShowingTheMostRecent',
                      )}{' '}
                      {total} versions
                    </span>
                  </div>
