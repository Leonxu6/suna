          ...
          {isEditing ? (
            ...
            <div
              ...
              title={tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsDriveToolbar.line191JsxAttrTitleDoubleClickToEditPath',
              )}
            >
              <Button
        ...
        <div className="flex w-full shrink-0 items-center gap-0.5 px-3 py-1.5 md:w-auto md:justify-end md:px-0 md:py-0">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-44">
              <DropdownMenuLabel>
                {tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsDriveToolbar.line262JsxTextSortBy',
                )}
              </DropdownMenuLabel>
              <DropdownMenuRadioGroup
                value={sortBy}
          ...
          <Button
            ...
            title={tHardcodedUi.raw(
              'featuresWorkspaceFilesComponentsDriveToolbar.line295JsxAttrTitleDownloadDirectoryAsZip',
            )}
          >
