 ...
 * (live sandbox vs. workspace git-ref); capabilities on the source decide which
            ...
            <div className="flex max-w-md items-center gap-2">
              ...
              <input
                ...
                placeholder={tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line594JsxAttrPlaceholderFolderName',
                )}
              />
            </div>
          )}
          {isCreatingFile && (
            <div className="flex max-w-md items-center gap-2">
              ...
              <input
                ...
                className="border-border focus:ring-primary flex-1 rounded-2xl border bg-transparent px-3 py-1.5 text-sm outline-none focus:ring-1"
                placeholder={tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line612JsxAttrPlaceholderFileName',
                )}
              />
            </div>
          )}
        ...
        <div className="absolute inset-0 overflow-y-auto">
          ...
          {!!error && !isLoading && (
            <ErrorState
              title={tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsFileExplorerPage.line658JsxTextFailedToLoadFiles',
              )}
          ...
          {isEmpty && (
            <EmptyState
              icon={FolderOpen}
              title={tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsDriveListView.line396JsxTextThisFolderIsEmpty',
              )}
              description={tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsDriveListView.line398JsxTextNoFilesOrSubfoldersAtThisPathIn',
              )}
            />
          )}
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div>
              <p className="text-foreground text-base font-medium">
                {tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line771JsxTextDropFilesToUpload',
                )}
              </p>
              <p className="text-muted-foreground mt-1 text-sm">
                {tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line773JsxTextFilesWillBeUploadedToTheCurrentDirectory',
                )}
              </p>
            </div>
          </div>
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsFileExplorerPage.line806JsxTextAreYouSureYouWantToDelete',
              )}{' '}
              <span className="text-foreground font-semibold">
                {tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line807JsxTextQuot',
                )}
                {deleteTarget?.name}
                {tHardcodedUi.raw(
                  'featuresWorkspaceFilesComponentsFileExplorerPage.line807JsxTextQuot32c14d98',
                )}
              </span>
              {tHardcodedUi.raw(
                'featuresWorkspaceFilesComponentsFileExplorerPage.line807JsxTextThisActionCannotBeUndone',
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
