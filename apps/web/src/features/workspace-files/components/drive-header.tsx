...
interface DriveHeaderProps {
  ...
  /**
   * Reserve room for the floating "open sidebar" toggle that the workspace shell
...
/**
 * Drive-style page header for the workspace Files section: plain-language
    ...
    >
      <div className="min-w-0 space-y-1">
        ...
        <p className="text-muted-foreground text-sm text-pretty">
          Every document, asset, and piece of work in this workspace lives here.
        </p>
      </div>
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        <Button
          ...
          title="Browse every saved version of this workspace"
