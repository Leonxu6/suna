...
const CREDIT_EXAMPLES: { label: string; body: string }[] = [
  { label: 'Free start', body: '200 credits covers sandbox runtime for early workspaces and demos.' },
  {
...
const FAQ: [string, string][] = [
  [
    ...
    'Free includes 200 credits each month for sandbox compute and 3 workspaces. Bring your own API key or connect your ChatGPT subscription for premium access. Managed Claude, GPT, and Gemini on Kortix keys are paid.',
  ],
  [
