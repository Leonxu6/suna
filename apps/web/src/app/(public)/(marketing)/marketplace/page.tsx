...
export const metadata: Metadata = {
  title: 'Marketplace — Clone a ready-made Kortix workspace',
  description:
    'Clone a full, working Kortix workspace in one click, or add skills from every source into your own.',
  openGraph: {
    title: 'Kortix Marketplace — Clone a ready-made Kortix workspace',
    description:
      'Clone a full, working Kortix workspace in one click, or add skills from every source into your own.',
...
export default async function MarketplacePage() {
  const { itemsPage, marketplacesPage, workspaceItems } = await loadMarketplaceExploreData();
