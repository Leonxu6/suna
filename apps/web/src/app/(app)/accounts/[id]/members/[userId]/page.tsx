...
// ─── V2: Workspaces this member can reach ───────────────────────────────────
...
function MemberWorkspaceAccessCard({
  ...
  const query = useQuery({
    queryKey: ['iam-member-workspace-access', accountId, memberUserId],
...
//      of common admin / workspace actions, renders allowed / denied
...
const SIMULATOR_PROBES: Array<{
  ...
  { action: 'workspace.create', label: 'Create workspaces', group: 'Workspaces' },
  { action: 'workspace.write', label: 'Edit workspaces', group: 'Workspaces' },
  { action: 'workspace.delete', label: 'Delete workspaces', group: 'Workspaces' },
  { action: 'workspace.members.manage', label: 'Manage workspace members', group: 'Workspaces' },
...
function ViewAsUserDialog({
  ...
  // resource-scoped actions like workspace.write on workspace X — the
    ...
    <Modal open={open} onOpenChange={onOpenChange}>
      <ModalContent className="lg:max-w-lg">
        ...
        <ModalBody className="max-h-[60vh] space-y-4 overflow-y-auto">
          ...
          <p className="text-muted-foreground text-xs">
            Workspace-by-workspace access is listed in the Workspaces section on the member page.
          </p>
        </ModalBody>
      </ModalContent>
    </Modal>
