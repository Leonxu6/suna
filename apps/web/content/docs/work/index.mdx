...
4. The agent works. It reads [secrets](/docs/workspace/secrets) as environment
...
<Cards>
  <Card title="Workspaces" href="/docs/workspace">A git repo with a manifest.</Card>
  <Card title="Agents" href="/docs/workspace/agents">A markdown persona with scoped tools.</Card>
  ...
  <Card title="Accounts" href="/docs/accounts">Who owns workspaces, and who can access them.</Card>
</Cards>
