...
description: Connectors, Slack, computers, and triggers reach outside a workspace.
---

import { Card, Cards } from 'fumadocs-ui/components/card';

A workspace reaches outside itself four ways. A connector calls an external
