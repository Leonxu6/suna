...
const forbiddenCapabilityIdentifiers = [
  ...
  'legacy-freestyle',
  'workspace.deploy',
  'workspace.read|write|delete|deploy',
  ...
  'workspace manifest (agents: map, triggers, sandbox, apps)',
  'workspace(id).apps',
  'building and deploying websites and apps',
  'deploys them as live apps',
  'can deploy them as live apps',
  'App deployment is governed by the workspace manifest',
  'deployed sites',
  ...
  'apps) on managed/self-hosted workspaces',
];
