...
describe('warmBakeCooldownGate — per-(workspace, provider) bake pacing', () => {
  ...
  test('workspaces cool down independently', () => {
    const registry = new Map<string, number>();
...
describe('warmBakeScopeId — per-(workspace, template) pacing scope', () => {
