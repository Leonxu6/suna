...
const envSchema = z.object({
  ...
  // switch that would change which workspace SECRETS are in scope. Ordinary
  ...
  // create-time agent. See workspaces/lib/secret-grant.ts.
  ...
  // client page a human opens directly. Defaults match the workspace's local dev
