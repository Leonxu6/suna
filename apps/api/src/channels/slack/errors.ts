...
// channel (or workspace default) was pointed at it. On a governed workspace this is
// caught at session-create (400 AGENT_NOT_DECLARED → inline picker); on a legacy
// workspace the session boots and opencode fails here when the agent markdown is
