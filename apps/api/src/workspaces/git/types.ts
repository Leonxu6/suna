// Shared types for the git-backed-workspace operations module.
// Pure leaf module: no runtime imports, only type declarations.

export interface GitBackedWorkspace {
  workspaceId: string;
  repoUrl: string;
...
// (commits) panels in the workspace file viewer. Internal types still use Git
