// Barrel for the git-backed-workspace operations module.
//
...
//              invalidateWorkspaceMirror, resolveTreeOid, materializeRepoContext
...
export { loadWorkspaceConfig } from './git/config';
