...
describe('buildSessionRuntimeEnv — KORTIX_COMPILED_AGENT_CONFIG', () => {
  ...
  test('omits the key entirely for a v1 workspace (compiledAgentConfig absent) — byte-for-byte unaffected', () => {
  ...
  test('carries the compiled JSON through verbatim for a v2 workspace', () => {
