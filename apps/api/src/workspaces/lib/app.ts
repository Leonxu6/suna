...
export const workspacesApp = makeOpenApiApp<AppEnv>();

export const workspaceWebhooksApp = new Hono<AppEnv>();

// ─── Reusable OpenAPI schemas (these power the docs, not runtime response
// validation). Core workspace-domain surfaces come from @kortix/api-contract —
...
/** The immediate-branch body: the updated workspace, tagged with `kind:'workspace'`. */
...
// PUBLIC workspaceion — status / providers / generation / timestamps / user-safe
