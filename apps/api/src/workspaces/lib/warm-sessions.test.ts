...
import {
  ...
  type WarmWorkspaceSessionRecord,
} from './warm-sessions';

function record(overrides: Partial<WarmWorkspaceSessionRecord> = {}): WarmWorkspaceSessionRecord {
  return {
    sessionId: 'session-1',
    status: 'running',
    baseRef: 'main',
...
describe('warm workspace session coordinator', () => {
