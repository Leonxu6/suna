...
export async function resolveWorkspaceAutomationActor(accountId: string): Promise<string | null> {
  const [row] = await db
 ...
 * TODO). Deliberately narrow: this is for RUN ATTRIBUTION (`workspace_sessions
