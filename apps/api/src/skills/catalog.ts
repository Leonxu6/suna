 ...
 * CLI). Until now they were only reachable two ways: scaffolded into a workspace's
 ...
 * *inside* Kortix. An agent in Claude Code / Codex / OpenCode holding nothing but
...
/** Where skills live inside a Kortix workspace (and inside the starter templates). */
