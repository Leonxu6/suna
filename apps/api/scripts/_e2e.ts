...
const prov=await (await fetch('http://localhost:8008/v1/workspaces/provision',{method:'POST',headers:H,body:JSON.stringify({name:'e2e-final',seed_starter:true})})).json() as any;
