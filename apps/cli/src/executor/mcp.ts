      ...
      try {
        ...
        return {
          content: content({
            ...
            expires_at: link.expires_at,
            instructions:
              'Surface this url to the human now. Web: opens a fill-in modal. Slack: tappable link. You never see the value; once submitted it appears in KORTIX_WORKSPACE_SECRET_NAMES.',
          }),
          isError: false,
        };
      } catch (err) {
