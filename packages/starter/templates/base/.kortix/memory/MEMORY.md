...
The **workspace memory** for `{{projectName}}` — durable, team-shared notes
this workspace keeps about itself (purpose, integrations, conventions,
...
its own sub-file) as the workspace grows. The **memory-reflector** agent
