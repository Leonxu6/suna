...
import { SANDBOX_PORTS } from '../rest/platform-client/types';
 ...
 */
const APP_ROUTE_PREFIXES = /^\/(connectors|settings|dashboard|workspaces|projects|agents|skills|tools|commands|support|changelog|files|p|browser|desktop|terminal|sessions|services|workspace|channels|scheduled-tasks|marketplace|templates|tunnel|admin|auth)(\/|$|\?)/;
